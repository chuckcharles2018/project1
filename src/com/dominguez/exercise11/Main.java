package com.dominguez.exercise11;
import java.util.*;
...
class  PressureSensor implements WeatherDataSource {
    ...
    private void updatePressure() {
        ...
        double high = 30.6;
        double low = 28;
        Currentpressure = new Random().nextDouble() * (high - low) + low;
    }
